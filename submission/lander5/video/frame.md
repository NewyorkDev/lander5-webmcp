...
description: >
  ...
  are identical and sacred — the green/pink/cream editorial triad, DM Sans at weight 500
...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "DM Sans", cqw: 1.56, weight: 400, lineHeight: 1.38 }
  body-card:{ fontFamily: "DM Sans", cqw: 1.35, weight: 400, lineHeight: 1.34 }
  ...
  # — display ramp (DM Sans weight 500, opsz, negative tracking) —
  title-card-sm:{ fontFamily: "DM Sans", cqw: 2.9, weight: 500, lineHeight: 0.98, tracking: "-0.01em" }
  title-card:{ fontFamily: "DM Sans", cqw: 3.5, weight: 500, lineHeight: 0.96, tracking: "-0.01em" }
  headline:{ fontFamily: "DM Sans", cqw: 4.4, weight: 500, lineHeight: 1.0, tracking: "-0.02em" }
  headline-xl:{ fontFamily: "DM Sans", cqw: 5.0, weight: 500, lineHeight: 0.96, tracking: "-0.02em" }
  display:{ fontFamily: "DM Sans", cqw: 7.3, weight: 500, lineHeight: 1.02, tracking: "-0.02em" }
  display-hero:{ fontFamily: "DM Sans", cqw: 11.5, weight: 500, lineHeight: 0.92, tracking: "-0.02em" }
  stat-figure:{ fontFamily: "DM Sans", cqw: 11.5, weight: 500, lineHeight: 0.92, tracking: "-0.03em" }
  stat-figure-unit:{ fontFamily: "DM Sans", cqw: 5.7, weight: 500, lineHeight: 0.92 }
  name:    { fontFamily: "DM Sans", cqw: 2.3, weight: 600, lineHeight: 1.0 }
...
- **Fonts** — already set to **DM Sans** (display) / **Fraunces** (body); ignore any preset font name lingering in prose.
...
Penguin classic or a quiet annual report. One confident voice, **DM Sans at weight 500**
...
- **DM Sans weight 500** (opsz, negative tracking) for all display; **serif 400** body; **JetBrains Mono 500** uppercase chrome.
...
- **Squint** — one DM Sans moment dominates at 3–6× its neighbor; the surface block centers the eye.
...
Two ramps. The **reading/chrome ramp** (DM Sans **400** body 1.56cqw; JetBrains Mono labels
in px) carries copy + chrome; the **display ramp** (DM Sans **500** `title-card-sm` 2.9cqw →
...
- Run every display in **DM Sans weight 500**, opsz, negative-tracked, tight line-height; **body at 400**.
...
- **Type** — DM Sans **500** display (opsz, negative-tracked) / **400** body; mono uppercase 0.08–0.18em; ≥1.4cqw floor.
...
- **DM Sans (opsz 8..60) + JetBrains Mono via Google Fonts** — the optical-size axis is critical; a non-opsz fallback flattens the size-aware letterforms. CJK: LXGW WenKai (display) / Noto Serif SC (body) / Noto Sans Mono CJK (chrome).
